...
public class PoseEstimator {
    ...
    public PoseEstimator() throws IOException {
        ...
        backends[0] = new PhotonVisionBackend(VisionConstants.SHOOTER_LL_NAME, VisionConstants.ROBOT_TO_SHOOTER_LL);
        backendToggles[0] = true;
    }
    ...
    {
        Logger.recordOutput("VisionPose", measurement.pose.toPose2d());
        SmartDashboard.putNumber("VisionPose_X", measurement.pose.toPose2d().getX());
        SmartDashboard.putNumber("VisionPose_Y", measurement.pose.toPose2d().getY());
    }
