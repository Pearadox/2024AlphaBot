...
//     private static final NetworkTable table = NetworkTableInstance.getDefault().getTable(VisionConstants.SHOOTER_LL_NAME);
...
//             botPose = table.getDoubleArrayTopic("botpose_wpired").subscribe(null);
//         }
//         else{
